...
const BOM: Record<Ship, Partial<Record<Component, number>>> = {
  ...
  Carrier: {
    "Capital Armor Plates": 48,
    "Capital Capacitor Battery": 34,
    "Capital Computer System": 48,
    "Capital Construction Parts": 48,
    "Capital Corporate Hangar Bay": 35,
    "Capital Drone Bay": 35,
    "Capital Jump Drive": 22,
    "Capital Power Generator": 48,
    "Capital Propulsion Engine": 48,
    "Capital Sensor Cluster": 48,
    "Capital Shield Emitter": 34,
    "Capital Ship Maintenance Bay": 35,
  },
  Supercarrier: {
